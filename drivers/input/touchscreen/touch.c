...
int tp_util_get_vendor(struct hw_resource *hw_res, struct panel_info *panel_data)
{
	...
	if (prj_id == 20669 || prj_id == 20751 || prj_id == 20750) {
		snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
...
int reconfig_power_control(struct touchpanel_data *ts)
{
    ...
    if ((prj_id == 20135 || prj_id == 20137 || prj_id == 20139 || prj_id == 20235) && !strstr(saved_command_line, "dsi_oppo20135samsung_amb655xl08_1080_2400_cmd_dvt")) {
