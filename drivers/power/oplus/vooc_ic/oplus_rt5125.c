...
static int rt5125_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_RT5125_4450_VOOC_FFC_5V6A_4BIT) {
		chip->firmware_data = rt5125_fw_data_4450_vooc_ffc_5v6a_4bit;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_vooc_ffc_5v6a_4bit);
		chip->fw_data_version = rt5125_fw_data_4450_vooc_ffc_5v6a_4bit[chip->fw_data_count - 4];
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_RT5125_4450_VOOC_FFC_5V6A_7BIT_ZEUS) {
		chip->firmware_data = rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_zeus;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_zeus);
		chip->fw_data_version = rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_zeus[chip->fw_data_count - 4];
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_RT5125_4450_VOOC_FFC_5V6A_7BIT_DARWIN) {
		chip->firmware_data = rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_darwin;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_darwin);
		chip->fw_data_version = rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_darwin[chip->fw_data_count - 4];
	} else if (chip->vooc_fw_type == VOOC_FW_TYPE_RT5125_4450_VOOC_FFC_10V5A_7BIT_LUNA) {
		chip->firmware_data = rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_luna;
		chip->fw_data_count = sizeof(rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_luna);
		chip->fw_data_version = rt5125_fw_data_4450_vooc_ffc_5v6a_7bit_luna[chip->fw_data_count - 4];
	}
