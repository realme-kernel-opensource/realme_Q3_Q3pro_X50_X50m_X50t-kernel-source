...
static struct rt9471_chip *rt9471 = NULL;
...
int oplus_rt9471_get_charger_volt(void);
int dump_more_reg = 0;
...
static int rt9471_inform_psy_changed(struct rt9471_chip *chip)
{
	...
	if (IS_ERR_OR_NULL(chip->psy)) {
		pr_notice("%s Couldn't get chip->psy\n", __func__);
	}
...
//	__rt9471_enable_autoaicr(rt9471,false);
	...
	chg_vol = oplus_rt9471_get_charger_volt();
...
bool oplus_rt9471_check_chrdet_status(void)
{
...
{
	int voltage = 0;
	voltage = mt6357_get_vbus_voltage();
	return voltage;
}

int oplus_rt9471_get_chargerid_volt(void)
{
	return 0;
}

int oplus_rt9471_enable_shipmode(bool en)
{
	return 0;
}
...
struct oplus_chg_operations  oplus_chg_rt9471_ops = {
	...
	.get_charger_volt = oplus_rt9471_get_charger_volt,
//	int (*get_charger_current)(void);
	.get_chargerid_volt = oplus_rt9471_get_chargerid_volt,
	...
	.check_chrdet_status = oplus_rt9471_check_chrdet_status,
...
//	void (*check_is_iindpm_mode) (void);
	...
	.enable_shipmode = rt9471_enable_shipmode,
};
