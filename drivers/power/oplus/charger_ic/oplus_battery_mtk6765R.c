	...
	enum power_supply_property psp, union power_supply_propval *val)
{
	...
	switch (psp) {
#if defined CONFIG_OPLUS_CHARGER_MT6370_TYPEC || defined CONFIG_OPLUS_CHARGER_MTK6765R
...
#if defined CONFIG_OPLUS_CHARGER_MT6370_TYPEC || defined CONFIG_OPLUS_CHARGER_MTK6765
